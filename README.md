...
- Run the [data collection code] first(https://github.com/RS201918703/Twitter-Analytics/blob/main/Data%20collection%20code.ipynb)
- Now, run the [main code](https://github.com/RS201918703/Twitter-Analytics/blob/main/Project%20code.ipynb)
